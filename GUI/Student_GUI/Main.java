...
public class Main {
    public static void main(String[] args) {
        ...
        ImageIcon originalImageIcon = new ImageIcon("./assets/Main Window.png"); // Replace "your_image_path.jpg" with the actual path to your image
        ...
        getStartedButton.setPreferredSize(new Dimension(150, 50)); // Set preferred size (width, height)
        ...
        getStartedButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                WelcomeToQuiz inputWindow = new WelcomeToQuiz();
